    ...
    <section>
      ...
      <div className="grid grid-cols-1 gap-4">
        {recentEpisodes.map((episode) => (
          <Card
            key={episode.id}
            className="group bg-gray-800/50 border-gray-700 hover:border-purple-500/50 transition-all duration-300 hover:bg-gray-800/70"
          >
                ...
                <div className="relative flex-shrink-0 flex items-center justify-center">
                  ...
                  {episode.isNew && (
                    <div className="absolute top-2 left-2">
                      <Badge className="secondary bg-amber-700">NEW</Badge>
                    </div>
                  )}
                </div>
